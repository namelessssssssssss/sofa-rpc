...
/**
 * StreamHandler -> StreamObserver
 * @author nameless
 */
public class StreamObserverAdapter<Response> implements StreamObserver<triple.Response> {
    ...
    public StreamObserverAdapter(StreamHandler<?> streamHandler,byte serializeType) {
